...
## Features
  ...
  - Comprehensive [documentation](http://mikemcl.github.io/bignumber.js/) and assessment set
...
The *assessment/modules* directory contains the assessment scripts for each method.
...
To assessment a single method, use, for example

    $ node assessment/methods/toFraction

For the browser, open *assessment/assessment.html*.
