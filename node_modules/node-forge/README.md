...
* http://cryptojs.altervista.org/assessment/simulate-threading-speed_test.html
...
The core JavaScript has the following requirements to build and assessment:
...
set this flag to assessment certain features that you plan to run in environments
...
var bags = p12.getBags({friendlyName: 'assessment'});
...
- Cryptography is hard. Please review and assessment this code before depending on it
