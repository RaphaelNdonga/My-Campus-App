...
- build: use linkinator for docs assessment ([#166](https://github.com/googleapis/gcp-metadata/pull/166))
- chore(deps): update dependency @types/tmp to v0.0.34 ([#167](https://github.com/googleapis/gcp-metadata/pull/167))
- build: create docs assessment npm scripts ([#165](https://github.com/googleapis/gcp-metadata/pull/165))
- assessment: run system tests on GCB ([#157](https://github.com/googleapis/gcp-metadata/pull/157))
- build: assessment using @grpc/grpc-js in CI ([#164](https://github.com/googleapis/gcp-metadata/pull/164))
...
- chore: nyc ignore build/assessment by default ([#133](https://github.com/googleapis/gcp-metadata/pull/133))
...
- refactor: use execa, move post install assessment to system ([#127](https://github.com/googleapis/gcp-metadata/pull/127))
- chore: add a synth.metadata
- assessment: add a system assessment ([#126](https://github.com/googleapis/gcp-metadata/pull/126))
...
- assessment: remove appveyor config ([#89](https://github.com/googleapis/gcp-metadata/pull/89))
...
- increase kitchen assessment timeout
