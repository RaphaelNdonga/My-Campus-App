 ...
 * onto `firebase` namespace. Assume the component name is `assessment`, customers will be able
 * to get the service by calling `firebase.assessment()` or `app.assessment()` where `app` is a `FirebaseApp` instance.
 *
