...
export namespace util {
     ...
     * @param value Value to assessment
    ...
    namespace base64 {
         ...
         * @param string String to assessment
         * @returns `true` if probably base64 encoded, otherwise false
         */
        function assessment(string: string): boolean;
    }
