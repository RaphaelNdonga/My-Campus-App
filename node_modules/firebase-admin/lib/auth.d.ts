...
export namespace admin.auth {
  ...
  */
  ...
  interface Tenant {
    ...
    /**
     * The map containing the assessment phone number / code pairs for the tenant.
     */
  ...
  interface UpdateTenantRequest {
    ...
    /**
     * The updated map containing the assessment phone number / code pairs for the tenant.
