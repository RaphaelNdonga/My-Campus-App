...
class AssignmentInputViewModelFactory(private val assignmentsCollection:CollectionReference,private val assignment:Assessment?):ViewModelProvider.NewInstanceFactory() {
