package com.mycampusapp.timetable.display.days.thursday
...
class ThursdayFragment : Fragment() {
    ...
    private val thursdayArgs by navArgs<ThursdayFragmentArgs>()
    ...
    override fun onCreateView(
        ...
        val dayCollection = courseCollection.document(courseId).collection(thursday.name)
                        ...
                        return@OnMenuItemClickListener when (it.itemId) {
                            R.id.skip_switch -> {
                                if(timetableClass.isActive) {
                                    ...
                                    dayCollection.document(timetableClass.id).set(skippedClass)
                                    viewModel.updateData(timetableClass.id, thursday, courseId)
                                }
                                true
                            }
                            else -> true
