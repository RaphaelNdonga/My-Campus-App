package com.mycampusapp.timetable.display.days.tuesday
...
class TuesdayFragment : Fragment() {
    ...
    private val tuesdayArgs by navArgs<TuesdayFragmentArgs>()
    ...
    override fun onCreateView(
        ...
        val dayCollection = courseCollection.document(courseId).collection(tuesday.name)
                        ...
                        return@OnMenuItemClickListener when (it.itemId) {
                            R.id.skip_switch -> {
                                if(timetableClass.isActive) {
                                    ...
                                    dayCollection.document(timetableClass.id).set(skippedClass)
                                    viewModel.updateData(timetableClass.id, tuesday, courseId)
                                }
                                true
                            }
                            else -> true
